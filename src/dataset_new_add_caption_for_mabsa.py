        ...
        ****************************template_list*********************************
        ...
        for part_id, part in enumerate(template_list):
            ...
            if part in special_token_mapping:
                ...
                # if N is not None or N > 0:
                #     new_input_token = [special_token_mapping['sep+']] + new_input_token ##_new_add_image_tokens
...
class FewShotDataset_new(torch.utils.data.Dataset):
    """Few-shot dataset."""
    ...
    def convert_fn(
        ...
        if verbose:
            ...
            # logger.info("the shape of image_pixel_values_list is {}".format(np.shape(features.image_pixel_values_list)))
...
def main():
    ...
    train_dataset = (
        FewShotDataset_new(data_args, tokenizer=tokenizer, mode="train", use_demo=("demo" in model_args.few_shot_type), add_image=model_args.add_image,
