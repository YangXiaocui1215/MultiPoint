...
class AddCaptionMVSAClassificationProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        file_name = os.path.join(data_dir, 'train_caption_not_use_beam_search.json')
        train_dataset=[]
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        file_name = os.path.join(data_dir, 'dev_caption_not_use_beam_search.json')
        dev_dataset=[]
        with open(file_name, 'r') as f:
            for line in f:
                json_line = json.loads(line)
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        file_name = os.path.join(data_dir, 'test_caption_not_use_beam_search.json')
        test_dataset=[]
        with open(file_name, 'r') as f:
            for line in f:
                json_line = json.loads(line)
