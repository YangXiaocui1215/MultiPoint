...
def tokenize_multipart_input(
    ...
    if prompt:
        ...
        *xx* represent variables:
        ...
        # print(' special_token_mapping is {}'.format( special_token_mapping ))
        ...
        for part_id, part in enumerate(template_list):
            ...
            if part in special_token_mapping:
                ...
                new_sent_tokens = enc(input_text_list[sent_id])  
                if 'tumblr' in task_name:
                   if len(new_sent_tokens)>45:
                        new_sent_tokens = new_sent_tokens[:45]
                new_tokens += new_sent_tokens
            elif part[:6] == '+sent_':
                # Add space
                sent_id = int(part.split('_')[1])
